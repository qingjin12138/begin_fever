...
/*If lv_conf.h is not skipped include it*/
        ...
        #include "lv_conf.h"
    #else
        #include "D:\Embedded chip and system design competition (Qinxin)\Ð¾Æ¬×ÊÁÏ\CH32V307EVTÀý³Ì\opench-ch32v307-master\firmware\IIC_Sensor\lvgl\lv_conf.h"                /*Else assume lv_conf.h is next to the lvgl folder*/
    #endif
